    ...
    this.shadow.innerHTML = `
      <style>
        ...
        *{box-sizing:border-box}button,select{font:inherit}button{cursor:pointer;transition:background-color .15s ease,transform .1s ease}
        ...
        .trigger svg{width:26px;height:26px;overflow:visible}.trigger .constellation{fill:none;stroke:white;stroke-width:4;stroke-linecap:round;stroke-linejoin:round}.trigger .node{fill:white}
      ...
      <button class="trigger" aria-label="${this.t('selectionTranslate')}"><svg viewBox="0 0 48 48" aria-hidden="true"><path class="constellation" d="M11.5 14 24 36 37.5 10.5"/><circle class="node" cx="11.5" cy="14" r="3.5"/><circle class="node" cx="24" cy="36" r="3.5"/><circle class="node" cx="37.5" cy="10.5" r="3.5"/></svg></button>
